...
unsigned char DSocket::data[20000];
unsigned char DSocket::vdata[300000];
unsigned char DSocket::adata[50000];
unsigned int DSocket::length=20000;
unsigned int DSocket::vlength=300000;
unsigned int DSocket::alength=50000;
