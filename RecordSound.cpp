...
ON_THREAD_MESSAGE_MY(MM_WIM_DATA, OnSoundData)
ON_THREAD_MESSAGE_MY(WM_RECORDSOUND_STARTRECORDING,OnStartRecording)
ON_THREAD_MESSAGE_MY(WM_RECORDSOUND_STOPRECORDING,OnStopRecording)
ON_THREAD_MESSAGE_MY(WM_RECORDSOUND_ENDTHREAD,OnEndThread)
END_MESSAGE_MAP()
