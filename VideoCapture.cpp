...
BOOL  VideoCapture::SetCapturePara()
{
	...
	m_bmpinfo.bmiHeader.biXPelsPerMeter = 0;//IMAGE_WIDTH;
	m_bmpinfo.bmiHeader.biYPelsPerMeter = 0;//IMAGE_HEIGHT;
...
DWORD pid = ::GetCurrentThreadId();
   ...
   if(vidcap!=NULL )
	  ((CVideoNetDlg*) (vidcap->dlg))->SendVideo(lphdr->lpData,lphdr->dwBytesUsed);
